 ...
 * a new row, not a schema change. hostTiers is a nested object, stored
 * as a JSON string in its own row.
 *
...
const DEFAULT_HOST_TIERS_ = {
  ...
  intermediate: { maxTrips: 20, percent: 15, minimum: 1000 },
  advanced: { percent: 30, minimum: 2000 },
};
