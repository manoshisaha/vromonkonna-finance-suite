...
function listTrips() {
  ...
  return trips.map((trip) => {
    ...
    return {
      ...
      tripEndDate: trip.TripEndDate ? formatDate_(trip.TripEndDate) : null,
      tripType: trip.TripType || 'domestic',
      tripDuration: trip.TripDuration || 'dayOnly',
      packagePrice: trip.PackagePrice,
      maxParticipants: trip.MaxParticipants,
      participantCount: trip.ParticipantCount !== '' && trip.ParticipantCount != null ? trip.ParticipantCount : null,
...
function saveTrip(payload) {
  ...
  const tripRow = {
    ...
    TripDuration: payload.tripType === 'domestic' ? (payload.tripDuration || 'dayOnly') : '',
    PackagePrice: payload.packagePrice,
    MaxParticipants: payload.maxParticipants || '',
    ParticipantCount: payload.participantCount != null ? payload.participantCount : (payload.participants || []).length,
